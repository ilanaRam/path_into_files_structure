...
class ArrangePath:
    ...
    def __init__(self, my_path: str):
        print(f"Object to be created with file structure given as a string: {my_path}")
        self.my_path: str = my_path
    ...
    def count_t_chars(self, my_str: str) -> tuple[int, str]:
        ...
        rest_of_string = re.sub(r'\\t+', # look for this regex
                                '',         # when find, replace with empty string - means remove the \\t founded by regex
    ...
    def validate_input(self) -> bool:
        ...
        if self.my_path is None or len(self.my_path) == 0:
    ...
    def calculate_longest_file_path(self) -> int:
        ...
        That later will be used for length calculation        
        """
